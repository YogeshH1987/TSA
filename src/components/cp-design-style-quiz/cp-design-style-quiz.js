...
function showTab(n) {
    ...
    var x = document.getElementsByClassName("quiz-step");
    ...
    if (n == 0) {
        document.getElementById("prevBtn").style.display = "flex";  // Hide prev on the first tab
    } else {
...
function validateForm() {
    ...
    x = document.getElementsByClassName("quiz-step");
...
document.addEventListener("DOMContentLoaded", function () {
    const quizItems = document.querySelectorAll(".cp-design-style-quiz");
